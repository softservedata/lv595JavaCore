...
public class IOHomeWork {
	public static void main(String[] args) {
		...
		try (BufferedWriter bw = new BufferedWriter (new FileWriter (outputFile))) {
			...
			bw.newLine();
			bw.append("\nLongest line is:\n").append(resultsMap.get("longestLineText")).append(String.format(".%nIt has %s symbols.", resultsMap.get("longestLine")));
			bw.newLine();
			
			bw.append(String.format("%nThis code written by %s, DOB - %s. Written on ", "Nazar Ivankiv", "26 January 1995") + " " + LocalDate.now());
