	...
	public static class IDAscendComparator implements Comparator<Employee>{
		...
		public int compare(Employee o1, Employee o2) {
			...
			if ((o1 instanceof ContractEmployee) && (o2 instanceof ContractEmployee)) {
				toReturn = ((ContractEmployee) o1).getFederalTaxIdmember().compareTo(((ContractEmployee) o2).getFederalTaxIdmember());
			} else if ((o1 instanceof SalariedEmployee) && (o2 instanceof SalariedEmployee)) {
				toReturn = ((SalariedEmployee) o1).getSocialSecurityNumber().compareTo(((SalariedEmployee) o2).getSocialSecurityNumber());
			} else if ((o1 instanceof ContractEmployee) && (o2 instanceof SalariedEmployee)) {
				toReturn = ((ContractEmployee) o1).getFederalTaxIdmember().compareTo(((SalariedEmployee) o2).getSocialSecurityNumber());
			} else if ((o2 instanceof ContractEmployee) && (o1 instanceof SalariedEmployee)) {
				toReturn = (((SalariedEmployee) o1).getSocialSecurityNumber().compareTo(((ContractEmployee) o2).getFederalTaxIdmember()));
			}
			return toReturn;
		}
	}
