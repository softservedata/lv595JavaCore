...
public class Hw4t1sb3 {

    public static void main(String[] args) throws Exception {
        String errorCode;
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Enter HTTPError's code :");
        errorCode = br.readLine();

        HTTPError httpError = HTTPError.valueOf(errorCode);
/*        httpError = httpError.knownHTTPError(errorCode);
        if (httpError.isMarked())
            System.out.println("Error " + httpError.getDescription());
        else
